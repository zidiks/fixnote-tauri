...
export interface DrawerProps {
  ...
  dismissable?: boolean;
  /** Whether the drawer blocks and dims the rest of the app. Default true. */
  modal?: boolean;
}
      ...
      {open ? (
        ...
        >
          ...
          <motion.aside
            ...
            className={cn(
              "pointer-events-auto absolute inset-y-0 flex w-80 max-w-[85vw] flex-col bg-background shadow-2xl",
              side === "right"
